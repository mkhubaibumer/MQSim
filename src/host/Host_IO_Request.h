...
namespace Host_Components {
    ...
    public:
        ...
        [[nodiscard]] std::string str() const {
            ...
            st << "Arrival Time: " << Arrival_time << " Enqueue Time: " << Enqueue_time
               << " Start LBA: " << Start_LBA << " LBA Count: " << LBA_count << " Type: " << (int) Type
               << " IO Queue Info: " << IO_queue_info << " Source Flow ID: " << Source_flow_id << "\n";
            return st.str();
        }
    };
}
